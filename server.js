...
const allowedOrigins = [
  ...
  "https://real-time-chat-web-app1.netlify.app/login",
];
...
server.listen(PORT, () => {
  ...
  console.log(`📡 WebSocket listening on ${PORT === 5000 ? "ws://localhost:5000" : "https://real-time-chat-app-backend-production.up.railway.app"}`);
});
